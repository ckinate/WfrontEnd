...
import { GeneralOperationsServiceServiceProxy, UiCustomizationSettingsDto } from '@shared/service-proxies/service-proxies';
...
export abstract class AppComponentBase {
    ...
    generalService: GeneralOperationsServiceServiceProxy;
    ...
    getCompanyCode(): string {
        ...
        return  this.appSession.companyCode;
    }
}
