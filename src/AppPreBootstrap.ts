    ...
    private static getApplicationConfig(
        ...
        XmlHttpRequestHelper.ajax(type, url, customHeaders, null, (result) => {
            ...
            if (tenancyName == null) {
                ...
                AppConsts.documentUrl = result.documentUrl;
                // AppConsts.documentUrl = result.documentUrl.replace(
                //     AppConsts.tenancyNamePlaceHolderInUrl + '.',
                //     ''
                // );
                AppConsts.identityServerURL = result.identityServerURL;
                // AppConsts.identityServerURL = result.identityServerURL.replace(
                //     AppConsts.tenancyNamePlaceHolderInUrl + '.',
                //     ''
                // );
                AppConsts.identityServerLogoutUrl = result.identityServerLogoutUrl;
                // AppConsts.identityServerLogoutUrl = result.identityServerLogoutUrl.replace(
                //     AppConsts.tenancyNamePlaceHolderInUrl + '.',
                //     ''
                // );
                 AppConsts.isIdentityServer = result.isIdentityServer;
                AppConsts.ClientId = result.ClientId;
                AppConsts.appRedirectUri = result.appRedirectUri;
                //  AppConsts.appRedirectUri = result.appRedirectUri.replace(
                //     AppConsts.tenancyNamePlaceHolderInUrl + '.',
                //     ''
                // );
            } else {
