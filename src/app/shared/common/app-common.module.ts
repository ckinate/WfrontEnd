...
import { FinTrakERPCommonModule } from '@shared/common/common.module';
...
import { WidgetPendingWorkflowComponent } from './customizable-dashboard/widgets/widget-pending-workflow/widget-pending-workflow.component';
...
@NgModule({
    ...
    declarations: [
        ...
        SubHeaderComponent,
        WidgetPendingWorkflowComponent,
        FilterPipe,
