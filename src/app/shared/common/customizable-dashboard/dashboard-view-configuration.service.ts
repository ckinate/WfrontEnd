...
import { WidgetPendingWorkflowComponent } from './widgets/widget-pending-workflow/widget-pending-workflow.component';
...
export class DashboardViewConfigurationService {
  ...
  private initializeConfiguration() {
    ...
    let pendingworkflow = new WidgetViewDefinition(
      DashboardCustomizationConst.widgets.tenant.pendingWorkflow,
      WidgetPendingWorkflowComponent, 6,6
    );
   ...
   this.WidgetViewDefinitions.push(pendingworkflow);
